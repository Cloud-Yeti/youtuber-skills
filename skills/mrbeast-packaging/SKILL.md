---
name: mrbeast-packaging
description: "The MrBeast pre-production method: conceive title + thumbnail BEFORE filming. Generate 50+ packaging concepts, rank by potential, then build the video to match. Use before recording any video."
argument-hint: "[video concept or topic area]"
---
...
1. **Video structure implied** — what does this title/thumbnail FORCE the video to be?
2. **First 5 seconds** — what must happen on screen to match the promise?
3. **Escalation path** — how does the video build from the packaging promise?
4. **Thumbnail variations** — 3 thumbnail directions for A/B testing
5. **Kill criteria** — what would make this packaging fail? (can we actually film this? is the claim defensible?)
