...
description: "Generate a research-backed thumbnail design brief. Faces (+35-50% CTR), 4 words max (+30% CTR), high contrast (+20-40% CTR), dark mode optimized. Use when planning thumbnails for a video."
argument-hint: "[video title and topic, or paste the title-formula output]"
---
