---
name: outlier-hunter
description: "Find outlier videos (3x+ above channel average) across niches. Extract the FORMAT, not the topic. Adapt with your brand voice. MrBeast's 'copy with taste' method. Use when hunting for video ideas."
argument-hint: "[your niche, or specific channels/topics to analyze]"
---
...
"There's only one time you should aim for originality: when you're adapting winning formats to your unique brand."
...
### Where to Look
1. **Your direct niche** — channels covering similar topics
2. **Adjacent niches** — similar audience, different topic
3. **Completely different niches** — same format, different everything
4. **Trending/breakout** — new channels that blew up with one video
